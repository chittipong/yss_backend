            ...
            <div class="col-lg-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'new')->radioList(['Y' => 'Yes', 'N' => 'No']) ?>

                        <?= $form->field($model, 'hot')->radioList(['Y' => 'Yes', 'N' => 'No']) ?>

                        <?= $form->field($model, 'promotion')->radioList(['Y' => 'Yes', 'N' => 'No']) ?>

                        <?= $form->field($model, 'best_seller')->radioList(['Y' => 'Yes', 'N' => 'No']) ?>

                        <?= $form->field($model, 'enable')->radioList(['Y' => 'Yes', 'N' => 'No']) ?>
                        ...
                        <?php if ($model->image): ?>
                            <div class="well">
                                ...
                                <?=
                                Html::a(
                                        '<i class="glyphicon glyphicon-trash"></i>', ['deleteimage', 'id' => $model->product_id, 'dir' => $model->productDir, 'field' => 'image'], ['class' => 'btn btn-danger']
                                )//แสดงปุ่ม delete
                                ?>
                            </div>
                        <?php endif; ?>
